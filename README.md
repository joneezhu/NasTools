...
[![GitHub stars](https://img.shields.io/github/stars/joneezhu/NasTools?style=plastic)](https://github.com/joneezhu/NasTools/stargazers)
...
```
教程见 [这里](https://raw.githubusercontent.com/joneezhu/NasTools/master/docker/readme.md) 。
...
```
git clone -b master https://github.com/joneezhu/NasTools --recurse-submodule 
