...
1. 如果曾经修改: 请去 https://raw.githubusercontent.com/joneezhu/NasTools-sites/master/user.sites.bin 下载后还原
2. 如果从未修改: 请去 https://github.com/joneezhu/NasTools/issues 创建issue，并附上报错信息
----------------------------------------------------------------------------------------------------------
            """
            log.info(f"【User】\n{recovery_msg}")
            return {}, [], {}
